...
class SwinTransformerSys(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        print(depths, depths_decoder, drop_path_rate, num_classes)
        ...
        #                nn.Linear(
        #                    in_features=224*224*embed_dim,
        #                    out_features=224*224,
        #                ),
        #                nn.Sigmoid(),
        #            )
...
if __name__ == "__main__":
    ...
    m = SwinTransformerSys(in_chans=4, num_classes=1)
    print(m)
    x = torch.randn(1, 4, 224, 224).to("cpu")
